...
import { Modal, ScrollView, View, Text, StyleSheet, Image } from "react-native";
...
const generateFormActions =
  (handleSubmit, reset) => (submitError, setSubmitError, handleFormSubmit) =>
    (
      <>
        {submitError ? (
          <View>
      ...
      <ScrollView>
        ...
        <Form
          ...
          actionButton={(handleSubmit, reset) =>
            generateFormActions(handleSubmit, reset)(
              submitError,
              setSubmitError,
              handleFormSubmit
            )
